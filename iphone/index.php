...
// Configuration
$config = [
    'ZENOPAY_API_KEY' => 'M7lrrn8-DSSAdBVi7vVfZxpmL2bjQAt_-NxMZH6mBAZr_efsoDjaFiZGejgzqeqsb1JbsZOcoN4AuSq4mNxbBQ',
...
<head>
    ...
    <style>
        /* Make sure the body takes the full viewport */
        html, body {
            height: 100%;
            margin: 0;
            padding: 0;
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: url('<?php echo "dazani.gif"; ?>') no-repeat center center;
            background-size: cover;
            z-index: -1;
        }

        /* Optional: Some foreground content */
        .content {
            position: relative;
            z-index: 1;
            color: white;
...
Connection zote zipo</p>
            ...
            <form id="paymentForm" class="payment-form">
                <div class="form-group">
                    <label for="phoneNumber">Namba ya simu yenye hela ukianza na sifuri</label>
